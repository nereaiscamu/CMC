...
def main(plot=True):
    ...
    ax[0,0].plot(n_disr, results_mutosc[:,0], label = "CPG model", linestyle="-")
    ax[0,0].plot(n_disr, results_mutosc[:,1], label = "Sensory feedback model", linestyle="-")
    ax[0,0].plot(n_disr, results_mutosc[:,2], label = "Hybrid model", linestyle="-")
    ax[0,0].legend()  
    ax[0,1].plot(n_disr, results_remcoup[:,0], label = "CPG model", linestyle="-")
    ax[0,1].plot(n_disr, results_remcoup[:,1], label = "Sensory feedback model", linestyle="-")
    ax[0,1].plot(n_disr, results_remcoup[:,2], label = "Hybrid model", linestyle="-")
    ax[0,1].legend()  
    ax[1,0].plot(n_disr, results_mutsens[:,0], label = "CPG model", linestyle="-")
    ax[1,0].plot(n_disr, results_mutsens[:,1], label = "Sensory feedback model", linestyle="-")
    ax[1,0].plot(n_disr, results_mutsens[:,2], label = "Hybrid model", linestyle="-")
    ax[1,0].legend()  
    ax[1,1].plot(n_disr, results_mixed[:,0], label = "CPG model", linestyle="-")
    ax[1,1].plot(n_disr, results_mixed[:,1], label = "Sensory feedback model", linestyle="-")
    ax[1,1].plot(n_disr, results_mixed[:,2], label = "Hybrid model", linestyle="-")
    ax[1,1].legend()       
    # Show plots
    if plot:
        plt.show()
